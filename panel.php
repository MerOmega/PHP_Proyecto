    ...
    <main class="contenedor_main">
                ...
                ?>
                        <tr class="tabla_producto">
                            ...
                            <div class="pop" id="cat<?php echo ($cat) ?>">
                                ...
                                <button type="submit" value="<?php echo ($row["idProducto"]) ?>" name="submit" class="boton">Cambiar</button><br><br>
                                </form>
                            </div>


                            <td data-modal-target=#cadu<?php echo $cadu ?>>
                                <div>
                            ...
                            <div class="pop" id="cadu<?php echo ($cadu) ?>">
                                ...
                                <div class="popbody">
                                    <form name="formulario" action="panel.php" method="POST">
                                        <br><input type="date" id="date" name="caducidad" min="<?php date('Y-m-d') ?>" max="2099-12-31"><br><br>
                                        <button type="submit" value="<?php echo ($row["idProducto"]) ?>" name="submit" class="boton">Cambiar</button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <td data-modal-target=#img<?php echo $img ?>>
                                <div>
        ...
        if (isset($_POST["submit"])) {
            ...
            if (isset($_POST["nombre"]) && !empty($_POST["nombre"])) {
                $nombre = $_POST["nombre"];
        ?> <script>
                    console.log(<?php echo $_POST["submit"] ?>)
                </script> <?php
